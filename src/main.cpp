...
// ======================GLAD+GLFW INITIALIZATION==============================
  ...
  Shader shader((shaderRoot / "vertex.glsl").c_str(),
                (shaderRoot / "fragment.glsl").c_str());
  Shader screenShader((shaderRoot / "screen" / "vertex.glsl").c_str(),
		      (shaderRoot / "screen" / "fragment.glsl").c_str());
float cubeVertices[] = {
  ...
  unsigned int cubeTexture  = loadTexture((projectRoot / "textures" / "container.jpg").c_str());
